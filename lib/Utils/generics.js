...
const generateMessageIDV2 = (userId) => {
    ...
    return 'ATOMIC-' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'ATOMIC-' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/mauricegift/ATOMIC-aileys/main/lib/Defaults/baileys-version.json';
    try {
