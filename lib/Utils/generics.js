...
const fonts = [
  "ATOMIC-", "atomic-", "𝙰𝚃𝙾𝙼𝙸𝙲-", "𝔸𝕋𝕆𝕄𝕀ℂ-", "𝖠𝖳𝖮𝖬𝖨𝖢-", 
  "𝐀𝐓𝐎𝐌𝐈𝐂-", "𝘼𝙏𝙊𝙈𝙄𝘾-", "𝓐𝓣𝓞𝓜𝓘𝓒-", "𝔄𝔗𝔒𝔐ℑℭ-", "ᴀᴛᴏᴍɪᴄ-", 
  "𝒜𝒯𝒪ℳℐ𝒞-", "𝕒𝕥𝕠𝕞𝕚𝕔-", "𝐚𝐭𝐨𝐦𝐢𝐜-", "𝖺𝗍𝗈𝗆𝗂𝖼-", "𝗮𝘁𝗼𝗺𝗶𝗰-", 
  "𝘢𝘵𝘰𝘮𝘪𝘤-", "𝙖𝙩𝙤𝙢𝙞𝙘-", "ⓐⓣⓞⓜⓘⓒ-", "ⒶⓉⓄⓂⒾⒸ-", "🄰🅃🅾🄼🄸🄲-", 
  "🅰🆃🅾🅼🅸🆲-", "ᗩTOᗰIᑕ-", "ΛTOMIC-", "дтоміс-", "αтσмι¢-", 
  "คt๏๓เς-", "ค₮ØMƗ€-", "ǟᏆօʍɨƈ-", "ᏗᏖᎧᎷᎥᏟ-", "คՇ๏๓เՇ-", 
  "卂ㄒㄖ爪丨匚-", "ﾑｲのﾼﾉᄃ-", "【﻿ＡＴＯＭＩＣ-】".slice(3,10), // Trims to 7
  "ɐʇoɯıɔ-", "A̶T̶O̶M̶I̶C̶-", "A̲T̲O̲M̲I̲C̲-", "A̴T̴O̴M...".slice(0,7), // Safety trim
  "A̷T̷O̷M̷I̷C̷-", "A̾T̾O̾M̾I̾C̾-", "A͓T͓O͓M͓I͓C͓-", "A͔T͔O͔M͔I͔C͔-", "A̺T̺O̺M̺I̺C̺-", 
  "A͙T͙O͙M͙I͙C͙-", "A̰T̰O̰M̰ḬC̰-", "A̴T̴O̴M̴I̴C̴-", "A̷T̷O̷M̷I̷C̷-", "A͡T͡O͡M͡I͡C͡-", 
  "A⃤T⃤O⃤M⃤I⃤C⃤-", "A⃚T⃚O⃚M⃚I⃚C⃚-", "A͎T͎O͎M͎I͎C͎-"
];
...
const generateMessageIDV2 = (userId) => {
    ...
    return 'randomFont' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'randomFont' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
