...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('groupStatusMessage' in message && !!message.groupStatusMessage) {
        // This will be handled by the giftedStatus handler in the socket
    ...
    if ('text' in message) {
        ...
        // This handles media messages (image, video, audio, document, sticker)
        m = await (0, exports.prepareWAMessageMedia)(message, options);
    }

    // Handle buttons - this should come AFTER media processing
    if ('buttons' in message && !!message.buttons && !('groupStatusMessage' in message)) {
    ...
    else if ('templateButtons' in message && !!message.templateButtons && !('groupStatusMessage' in message)) {
        const msg = {
    ...
    else if ('sections' in message && !!message.sections && !('groupStatusMessage' in message)) {
        const listMessage = {
    ...
    // Handle interactive buttons
    else if ('interactiveButtons' in message && !!message.interactiveButtons && !('groupStatusMessage' in message)) {
        ...
        if ('text' in message) {
            ...
            interactiveMessage.header = {
                ...
                hasMediaAttachment: (_a = message === null || message === void 0 ? void 0 : message.media) !== null && _a !== void 0 ? _a : false,
            };
        ...
        if ('title' in message && !!message.title) {
            interactiveMessage.header = {
                title: message.title,
                subtitle: message.subtitle,
                hasMediaAttachment: (_b = message === null || message === void 0 ? void 0 : message.media) !== null && _b !== void 0 ? _b : false,
            };
            Object.assign(interactiveMessage.header, m);
        }
    ...
    // Handle mentions
    if ('mentions' in message && ((_c = message.mentions) === null || _c === void 0 ? void 0 : _c.length)) {
...
// Add getSenderLid function if needed
